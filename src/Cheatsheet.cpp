...
#include "../include/SFST/Cheatsheet.hpp"
...
namespace sfst {
   ...
   **********************************************************************/
   ...
   KeyBind::KeyBind(const INPUT_TYPE inputType,
   ...
   bool
   KeyBind::testEvent(const KeyBind& k, const sf::Event& e) const
   {
      // Mouse event
   ...
   /* } */
   bool
   operator==(const KeyBind& k1, const KeyBind& k2)
   {
