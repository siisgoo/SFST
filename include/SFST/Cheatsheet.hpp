...
namespace sfst
{
    ...
    class KeyBind {
        ...
        /* KeyBind() = delete; */
        KeyBind();
        KeyBind(const INPUT_TYPE inputType, const sf::Keyboard::Key& key,    const sf::Event::EventType& event = sf::Event::KeyPressed);
        KeyBind(const INPUT_TYPE inputType, const sf::Mouse::Button& button, const sf::Event::EventType& event = sf::Event::MouseLeft);
